...
<ul id="nav">
  ...
  <div class="content">
    ...
    <form method="post" action="Index_apoyosote_admi.php">
      <p>
      Correo :
      <br>
        <input type="email" name="nombreadmin" id="nombreadmin" placeholder="Ingrese Correo" required />
      </p>
      <p>Contraseña: 
      <br>
        <input type="password" name="contraadmin" id="contraadmin" placeholder="Ingrese Contraseña" required />
      </p>
