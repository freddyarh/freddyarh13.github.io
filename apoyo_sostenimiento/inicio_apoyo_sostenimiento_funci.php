...
<ul id="nav">
  ...
  <div class="content">
    ...
    <form name="Index_apoyososte_funci" method="post" action="Index_apoyosote_funci.php">
      <p>
      Correo :
      <br>
        <input type="email" name="nombre_usuario_apoyo" id="nombre_usuario_apoyo"  placeholder="Ingrese Correo"  required>
      </p>
      <p>Contraseña: 
      <br>
        <input type="password" name="contrafunciapoyo" id="contrafunciapoyo" placeholder="Ingrese Contraseña" required>
      </p>
