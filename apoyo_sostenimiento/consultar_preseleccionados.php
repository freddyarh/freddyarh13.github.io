...
require_once ('conexion.php');
 ...
 $registros = mysql_query ("select * from pre_seleccionados ",$conexion)or die("Error en la consulta".mysql_error());
 ?>
 <body id="dt_example">
		<div id="container">
	...
	<tr class="odd_gradeX">
	    ...
	    <td class="center"><?PHP echo $reg['estrato'] ?></td>
	    <td class="center"><?PHP echo $reg['puntaje'] ?> </td>
	</tr>
    <?PHP
    }
    ?>
