...
<img src="/APSOS/LOGOS/8.jpg" width="194" height="173">
 ...
 <div class="banner"><h1>
<marquee><img src="/APSOS/LOGOS/apsosban.gif" width="468" height="173"></marquee></h1>
 </div>
...
<ul id="nav">
  ...
  <div class="content">
    ...
    <form name="index_planes" method="post" action="index_planes.php">
      <p>
      Correo :
      <br>
        <input type="email" name="nombre_usuario_plan" id="nombre_usuario_plan" placeholder="Ingrese Correo" required>
      </p>
      <p>Contraseña: 
      <br>
        <input type="password" name="contra_plan" id="contra_plan" placeholder="Ingrese Contraseña"required>
      </p>
